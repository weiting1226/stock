// 九頁共用的介面增強。純漸進式：不載入這支檔案，每一頁仍然完整可用。
//
...
// 實測既有頁面裡只有估值表會溢出（1280px 下 8px），其餘全部放得下。
//
...
const MODULE_INFO = {
  ...
  "diaper.html": "尿布 M 號各平台最便宜單片價，跌破近期均價顯著標示",
  "gap_radar.html": "機構買評裡現價與目標價落差最大的10檔，附分歧度風險分層",
};
